...
[06:39:18] 🐙 Pulling code changes from Github...
[06:39:18] 📦 Processing dependencies...
[06:39:18] 📦 Processed dependencies!
[06:39:20] 🔄 Updated app!
2026-05-28 06:41:22.524 Script compilation error
Traceback (most recent call last):
  ...
  File "/mount/src/israel-water-quality/app.py", line 2
    [     UTC     ] Logs for israel-water-quality.streamlit.app/
      ^
SyntaxError: invalid non-printable character U+2009
2026-05-28 06:41:22.531 Thread 'MainThread': missing ScriptRunContext! This warning can be ignored when running in bare mode.
2026-05-28 06:41:52.529 Script compilation error
Traceback (most recent call last):
  File "/home/adminuser/venv/lib/python3.14/site-packages/streamlit/runtime/scriptrunner/script_runner.py", line 591, in _run_script
    code = self._script_cache.get_bytecode(script_path)
  File "/home/adminuser/venv/lib/python3.14/site-packages/streamlit/runtime/scriptrunner/script_cache.py", line 72, in get_bytecode
  ...
  File "/mount/src/israel-water-quality/app.py", line 2
    [     UTC     ] Logs for israel-water-quality.streamlit.app/
      ^
SyntaxError: invalid non-printable character U+2009
2026-05-28 06:41:52.531 Thread 'MainThread': missing ScriptRunContext! This warning can be ignored when running in bare mode.
[06:42:39] 🐙 Pulling code changes from Github...
[06:42:40] 📦 Processing dependencies...
[06:42:40] 📦 Processed dependencies!
[06:42:41] 🔄 Updated app!
2026-05-28 06:42:45.848 Please replace `st.components.v1.html` with `st.iframe`.

`st.components.v1.html` will be removed after 2026-06-01.
2026-05-28 06:42:45.848 Please replace `st.components.v1.html` with `st.iframe`.

`st.components.v1.html` will be removed after 2026-06-01.
2026-05-28 06:42:45.903 Please replace `st.components.v1.html` with `st.iframe`.

`st.components.v1.html` will be removed after 2026-06-01.
2026-05-28 06:42:45.904 Please replace `st.components.v1.html` with `st.iframe`.
...
/mount/src/israel-water-quality/app.py:452: DeprecationWarning: datetime.datetime.utcfromtimestamp() is deprecated and scheduled for removal in a future version. Use timezone-aware objects to represent datetimes in UTC: datetime.datetime.fromtimestamp(timestamp, datetime.UTC).
  s3_dates = set(datetime.utcfromtimestamp(d/1000).strftime(date_fmt) for d in s3_ts)
/mount/src/israel-water-quality/app.py:511: DeprecationWarning: datetime.datetime.utcnow() is deprecated and scheduled for removal in a future version. Use timezone-aware objects to represent datetimes in UTC: datetime.datetime.now(datetime.UTC).
  age_h      = (datetime.utcnow() - datetime.utcfromtimestamp(img_time/1000)).total_seconds() / 3600
/mount/src/israel-water-quality/app.py:511: DeprecationWarning: datetime.datetime.utcfromtimestamp() is deprecated and scheduled for removal in a future version. Use timezone-aware objects to represent datetimes in UTC: datetime.datetime.fromtimestamp(timestamp, datetime.UTC).
  age_h      = (datetime.utcnow() - datetime.utcfromtimestamp(img_time/1000)).total_seconds() / 3600
2026-05-28 06:42:54.110 Please replace `use_container_width` with `width`.

`use_container_width` will be removed after 2025-12-31.

For `use_container_width=True`, use `width='stretch'`. For `use_container_width=False`, use `width='content'` or specify an integer width.
2026-05-28 06:42:54.125 Please replace `use_container_width` with `width`.

`use_container_width` will be removed after 2025-12-31.

For `use_container_width=True`, use `width='stretch'`. For `use_container_width=False`, use `width='content'` or specify an integer width.
[06:43:00] 🔌 Disconnecting...
[06:43:06] 🖥 Provisioning machine...
[06:43:11] 🎛 Preparing system...
[06:43:12] ⛓ Spinning up manager process...
[06:42:58] 🚀 Starting up repository: 'israel-water-quality', branch: 'main', main module: 'app.py'
[06:42:58] 🐙 Cloning repository...
[06:42:58] 🐙 Cloning into '/mount/src/israel-water-quality'...

[06:42:59] 🐙 Cloned repository!
[06:42:59] 🐙 Pulling code changes from Github...
[06:42:59] 📦 Processing dependencies...

──────────────────────────────────────── uv ───────────────────────────────────────────

Using uv pip install.
Using Python 3.14.5 environment at /home/adminuser/venv
Resolved 74 packages in 696ms
Prepared 74 packages in 2.07s
Installed 74 packages in 79ms
 ...
 + cffi==2.0.0
 + charset-normalizer==3.4.7
 + click==[2026-05-28 06:43:02.402067] 8.4.1
 + cryptography==48.0.0
 + distro==1.9.0
 + earthengine-api==1.7.28
 + folium==0.20.0
 + gitdb==4.0.12
 + gitpython==3.1.50[2026-05-28 06:43:02.402327] 
 + google-api-core==2.30.3
 + google-api-python-client==2.196.0
 + google-auth==2.53.0
 + google-auth-httplib2==0.4.0
 + google-cloud-core==2.6.0[2026-05-28 06:43:02.402597] 
 + google-cloud-storage==3.10.1
 + google-crc32c==1.8.0
 + google-genai==2.6.0
 + google-resumable-media==2.9.0
 + googleapis-common-protos[2026-05-28 06:43:02.402820] ==1.75.0
 + h11==0.16.0
 + httpcore==1.0.9
 + httplib2==0.31.2
 + httptools==[2026-05-28 06:43:02.403067] 0.8.0
 + httpx==0.28.1
 + idna==3.16
 + itsdangerous==2.2.0
 + jinja2==3.1.6[2026-05-28 06:43:02.403347] 
 + jsonschema==4.26.0
 + jsonschema-specifications==2025.9.1
 + markupsafe==3.0.3
 + narwhals==2.21.2
 + numpy[2026-05-28 06:43:02.403625] ==2.4.6
 + packaging==26.2
 + pandas==3.0.3
 + pillow==12.2.0
 + proto-plus==1.28.0
 + protobuf==7.35.0[2026-05-28 06:43:02.403843] 
 + pyarrow==24.0.0
 + pyasn1==0.6.3
 + pyasn1-modules==0.4.2
 + pycparser==3.0
 + pydantic==2.13.4
 + pydantic-core==2.46.4[2026-05-28 06:43:02.404024] 
 + pydeck==0.9.2
 + pyparsing==3.3.2
 + python-dateutil==2.9.0.post0
 + python-multipart==0.0.29
 + referencing==0.37.0
 + [2026-05-28 06:43:02.404219] requests==2.34.2
 + rpds-py==0.30.0
 + six==1.17.0
 + smmap==5.0.3
 + sniffio==1.3.1
 + starlette==1.1.0[2026-05-28 06:43:02.404386] 
 + streamlit==1.57.0
 + streamlit-folium==0.27.2
 + tenacity==9.1.4
 + toml==0.10.2
 + typing-extensions==4.15.0
 + typing-inspection==0.4.2[2026-05-28 06:43:02.404603] 
 + uritemplate==4.2.0
 + urllib3==2.7.0
 + uvicorn==0.48.0
 + watchdog==6.0.0
 + websockets==16.0
 + xyzservices==2026.3.0[2026-05-28 06:43:02.404782] 
Checking if Streamlit is installed
Found Streamlit version 1.57.0 in the environment
Installing rich for an improved exception logging
Using uv pip install.
...
Installed 4 packages in 14ms
 +[2026-05-28 06:43:03.993576]  markdown-it-py==4.2.0
 + mdurl==0.1.2
 + pygments==2.20.0
 + rich==15.0.0
...
[06:43:04] 🐍 Python dependencies were installed from /mount/src/israel-water-quality/requirements.txt using uv.
Check if streamlit is installed
Streamlit is already installed
[06:43:05] 📦 Processed dependencies!
2026-05-28 06:43:07.005 Uvicorn server started on 0.0.0.0:8501



2026-05-28 06:43:30.644 Please replace `st.components.v1.html` with `st.iframe`.

`st.components.v1.html` will be removed after 2026-06-01.
2026-05-28 06:43:30.645 Please replace `st.components.v1.html` with `st.iframe`.
...
/mount/src/israel-water-quality/app.py:511: DeprecationWarning: datetime.datetime.utcfromtimestamp() is deprecated and scheduled for removal in a future version. Use timezone-aware objects to represent datetimes in UTC: datetime.datetime.fromtimestamp(timestamp, datetime.UTC).
  age_h      = (datetime.utcnow() - datetime.utcfromtimestamp(img_time/1000)).total_seconds() / 3600
2026-05-28 06:43:36.837 Please replace `use_container_width` with `width`.
