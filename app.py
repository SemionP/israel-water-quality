...
def run_fusion_pipeline() -> pd.DataFrame:
    ...
    grid=build_grid()
    layers=[
        (_get_s3:=get_s3_fusion_layer(aoi),"WQI_S3","cloud_S3","valid_S3","S3",300),
        (_gm:=get_modis_fusion_layer(aoi),"WQI_MODIS","cloud_MODIS","valid_MODIS","MODIS",500),
        (_gs:=get_s2_fusion_layer(aoi),"WQI_S2","cloud_S2","valid_S2","S2",300),
    ]
